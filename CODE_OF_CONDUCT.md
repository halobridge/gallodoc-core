...
The GalloDoc Core community follows the
...
Report violations to **conduct@halobridge.ai**. Reports remain confidential.
The maintainers will review and respond within five business days.

For security or vulnerability reports, see [SECURITY.md](SECURITY.md).
